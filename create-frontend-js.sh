#!/bin/bash
cat > /home/user/umchs-inventory/frontend/dist/app.js << 'JSEOF'
...
cat > /home/user/umchs-inventory/frontend/dist/manifest.json << 'MANIFESTEOF'
{
  "name": "UMCHS Inventory Tracker",
  "short_name": "Inventory",
  "description": "Track inventory, supplies, purchases, budgets, and location requests",
  "start_url": "/",
  "display": "standalone",
...
cat > /home/user/umchs-inventory/frontend/dist/sw.js << 'SWEOF'
...
echo "✅ Frontend complete (JS + manifest + service worker)"
