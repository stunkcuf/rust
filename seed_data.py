#!/usr/bin/env python3
"""Seed data script for UMCHS Inventory System"""
import requests, json, sys

API_BASE = sys.argv[1].rstrip('/') + "/api" if len(sys.argv) > 1 else "http://localhost:3000/api"
print(f"Using API: {API_BASE}")

def register_admin():
    try:
        response = requests.post(f"{API_BASE}/auth/register", json={
            "username": "admin", "email": "admin@umhs.org", "password": "admin123", "role": "admin"
        })
        if response.status_code == 200:
            ...
            response = requests.post(f"{API_BASE}/auth/login", json={"username": "admin", "password": "admin123"})
            if response.status_code == 200:
                data = response.json()
...
ITEMS = [
    ...
    {"name": "Size 2 Diapers (240/box)", "sku": "DIAPER-2", "category": "Baby Supplies", "unit_price": 40.00, "reorder_level": 5, "overstock_level": 50},
    {"name": "Size 3 Diapers (210/box)", "sku": "DIAPER-3", "category": "Baby Supplies", "unit_price": 40.00, "reorder_level": 5, "overstock_level": 50},
    {"name": "Size 4 Diapers (192/box)", "sku": "DIAPER-4", "category": "Baby Supplies", "unit_price": 40.00, "reorder_level": 5, "overstock_level": 50},
    {"name": "Size 5 Diapers (162/box)", "sku": "DIAPER-5", "category": "Baby Supplies", "unit_price": 40.00, "reorder_level": 5, "overstock_level": 50},
    {"name": "Size 6 Diapers (132/box)", "sku": "DIAPER-6", "category": "Baby Supplies", "unit_price": 40.00, "reorder_level": 5, "overstock_level": 50},
    {"name": "Size 7 Diapers (72/box)", "sku": "DIAPER-7", "category": "Baby Supplies", "unit_price": 40.00, "reorder_level": 3, "overstock_level": 30},
    {"name": "Size 8 Diapers (64/box)", "sku": "DIAPER-8", "category": "Baby Supplies", "unit_price": 40.00, "reorder_level": 3, "overstock_level": 30},
    {"name": "Diaper Wipes (1200/box)", "sku": "WIPES-1200", "category": "Baby Supplies", "unit_price": 25.00, "reorder_level": 10, "overstock_level": 100},
    {"name": "Diaper Genie Bags", "sku": "GENIE-BAGS", "category": "Baby Supplies", "unit_price": 15.00, "reorder_level": 5, "overstock_level": 50},
    {"name": "Foaming Hand Soap (6/case)", "sku": "SOAP-FOAM-6", "category": "Bathroom Supplies", "unit_price": 24.00, "reorder_level": 3, "overstock_level": 30},
    ...
    {"name": "Microfiber Cloths 12x12 (12pk)", "sku": "CLOTH-12X12", "category": "Cleaning Materials", "unit_price": 15.00, "reorder_level": 5, "overstock_level": 50},
    {"name": "Magic Eraser Sponge (6pk)", "sku": "ERASER-6", "category": "Cleaning Materials", "unit_price": 12.00, "reorder_level": 5, "overstock_level": 50},
    {"name": "Cleaning Sponge (6pk)", "sku": "SPONGE-6", "category": "Cleaning Materials", "unit_price": 8.00, "reorder_level": 5, "overstock_level": 50},
    {"name": "Spray Bottle", "sku": "SPRAY-BOTTLE", "category": "Cleaning Materials", "unit_price": 3.00, "reorder_level": 10, "overstock_level": 100},
    {"name": "Mop Head Replacement (6pk)", "sku": "MOP-HEAD-6", "category": "Cleaning Materials", "unit_price": 25.00, "reorder_level": 3, "overstock_level": 30},
    ...
    {"name": "Broom & Dust Pan Set", "sku": "BROOM-SET", "category": "Cleaning Materials", "unit_price": 12.00, "reorder_level": 5, "overstock_level": 30},
    {"name": "Nutra Care Floor Cleaner (4gal)", "sku": "FLOOR-CLEAN-4G", "category": "Cleaning Products", "unit_price": 45.00, "reorder_level": 5, "overstock_level": 50},
    ...
    {"name": "Disinfectant Wipes", "sku": "DISINFECT-WIPE", "category": "Cleaning Products", "unit_price": 15.00, "reorder_level": 10, "overstock_level": 100},
    {"name": "Bleach, Gallon", "sku": "BLEACH-GAL", "category": "Cleaning Products", "unit_price": 5.00, "reorder_level": 10, "overstock_level": 100},
    {"name": "Dawn Dish Soap", "sku": "DISH-SOAP", "category": "Cleaning Products", "unit_price": 4.00, "reorder_level": 10, "overstock_level": 100},
    ...
    {"name": "Toilet Paper (96 rolls)", "sku": "TP-96", "category": "Paper Products", "unit_price": 45.00, "reorder_level": 10, "overstock_level": 100},
    {"name": "Trifold Paper Towels (16pkg)", "sku": "TOWEL-TRI-16", "category": "Paper Products", "unit_price": 40.00, "reorder_level": 10, "overstock_level": 100},
    ...
    {"name": "Facial Tissue Box (30/case)", "sku": "TISSUE-30", "category": "Paper Products", "unit_price": 30.00, "reorder_level": 10, "overstock_level": 100},
    {"name": "Exam Table Paper (12pkg)", "sku": "EXAM-PAPER-12", "category": "Paper Products", "unit_price": 50.00, "reorder_level": 3, "overstock_level": 30},
    {"name": "Small Trash Bags (500/box)", "sku": "TRASH-SM-500", "category": "Trash Bags", "unit_price": 25.00, "reorder_level": 5, "overstock_level": 50},
    {"name": "Large Trash Bags (150/box)", "sku": "TRASH-LG-150", "category": "Trash Bags", "unit_price": 30.00, "reorder_level": 5, "overstock_level": 50},
    ...
    {"name": "Copy Paper (10 reams)", "sku": "PAPER-COPY-10", "category": "Office - Paper", "unit_price": 50.00, "reorder_level": 5, "overstock_level": 50},
    {"name": "Legal Paper (reams)", "sku": "PAPER-LEGAL", "category": "Office - Paper", "unit_price": 8.00, "reorder_level": 5, "overstock_level": 50},
    {"name": "Index Cards 3x5", "sku": "INDEX-3X5", "category": "Office - Paper", "unit_price": 5.00, "reorder_level": 10, "overstock_level": 100},
    {"name": "Index Cards 4x6", "sku": "INDEX-4X6", "category": "Office - Paper", "unit_price": 6.00, "reorder_level": 10, "overstock_level": 100},
    ...
    {"name": "Small Nitrile Gloves (1000/case)", "sku": "GLOVE-NIT-S-1000", "category": "Gloves", "unit_price": 80.00, "reorder_level": 3, "overstock_level": 30},
    {"name": "Medium Nitrile Gloves (1000/case)", "sku": "GLOVE-NIT-M-1000", "category": "Gloves", "unit_price": 80.00, "reorder_level": 5, "overstock_level": 50},
    {"name": "Large Nitrile Gloves (1000/case)", "sku": "GLOVE-NIT-L-1000", "category": "Gloves", "unit_price": 80.00, "reorder_level": 5, "overstock_level": 50},
    {"name": "X-Large Nitrile Gloves (1000/case)", "sku": "GLOVE-NIT-XL-1000", "category": "Gloves", "unit_price": 80.00, "reorder_level": 3, "overstock_level": 30},
    ...
    {"name": "Single Creamers", "sku": "CREAM-REG", "category": "Pantry", "unit_price": 15.00, "reorder_level": 10, "overstock_level": 100},
    {"name": "Preschool Toothbrushes (144/box)", "sku": "TOOTH-PRESCHOOL-144", "category": "Toothbrushing", "unit_price": 30.00, "reorder_level": 5, "overstock_level": 50},
    {"name": "Infant Toothbrushes (24/box)", "sku": "TOOTH-INFANT-24", "category": "Toothbrushing", "unit_price": 15.00, "reorder_level": 5, "overstock_level": 50},
    {"name": "Toothpaste (144 tubes)", "sku": "TOOTHPASTE-144", "category": "Toothbrushing", "unit_price": 35.00, "reorder_level": 5, "overstock_level": 50},
    {"name": "3oz Drinking Cups (1200)", "sku": "CUP-3OZ-1200", "category": "Toothbrushing", "unit_price": 20.00, "reorder_level": 5, "overstock_level": 50},
]
...
def main():
    print("=" * 60)
    print("UMCHS Inventory Tracker - Seed Data Script")
    print("=" * 60)
    print()
