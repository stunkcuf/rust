...
// Inventory model (stock levels per location)
#[derive(Debug, Clone, Serialize, Deserialize, FromRow)]
...
pub struct PurchaseWithDetails {
    ...
    pub status: String,
    pub ordered_by: i64,
    pub ordered_by_username: String,
    pub ordered_at: DateTime<Utc>,
}
...
#[derive(Debug, Deserialize)]
pub struct UpdatePurchaseStatus {
    pub status: String,
}

// Item Request model (locations requesting items)
#[derive(Debug, Clone, Serialize, Deserialize, FromRow)]
...
#[derive(Debug, Deserialize)]
pub struct UpdateItemRequestStatus {
    pub status: String,
}
